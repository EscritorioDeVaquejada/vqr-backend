...
public class PagedClientResponseVO implements Serializable {
    @Serial
    ...
    public PagedClientResponseVO() {
    }

    public PagedClientResponseVO(Long totalElements, Integer totalPages, Integer size, List<ClientResponseVO> content, Integer number, Sort sort, Boolean first, Boolean last, Integer numberOfElements, Boolean empty) {
    ...
    public boolean equals(Object object) {
        ...
        PagedClientResponseVO that = (PagedClientResponseVO) object;
